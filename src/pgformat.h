...
///////////////////////////////////////////////////////////////////////////////
template <typename T = std::experimental::any>
class PGFormatType
{
public:
    using value_type = T;

    using decode_function = std::function<value_type(const Buffer::value_type *buf, int sz)>;
    ...
    //------------------------------------------------------------------------
    virtual value_type decode(const FieldSpec &fs, const Buffer::value_type *buf, int sz) const
    {
