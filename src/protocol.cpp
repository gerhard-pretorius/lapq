...
template<>
void serialize(const std::vector<decltype(pg::FieldSpec::type_oid)> &oid, Buffer &b)
{
...
//----------------------------------------------------------------------------
template<typename T>
Buffer::size_type deserialize(T &t, const Buffer &buf, const Buffer::size_type pos = 0)
{
    return 0;
}

template<>
Buffer::size_type deserialize(std::string &s, const Buffer &buf, const Buffer::size_type pos)
{
    s.clear();
...
//----------------------------------------------------------------------------
Buffer::size_type deserializeInt16(int &t, const Buffer &b, const Buffer::size_type pos = 0)
{
...
//----------------------------------------------------------------------------
Buffer::size_type deserializeInt32(int &t, const Buffer &b, const Buffer::size_type pos = 0)
{
...
//----------------------------------------------------------------------------
Buffer::size_type deserializeByte1(char &c, const Buffer &buf, const Buffer::size_type pos = 0)
{
    auto tmp = reinterpret_cast<const char *>(buf.data() + pos);
    c = *tmp;
    return 1;
...
//----------------------------------------------------------------------------
Buffer::size_type deserializeByte4(Byte4 &a, const Buffer &buf, const Buffer::size_type pos = 0)
{
...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
std::error_code Message::serialize(const Message &msg, Buffer &header_buf, Buffer &body_buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
std::error_code Authentication::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code BindComplete::deserialize(const Header &header, const Buffer &buf)
{
    if (buf.size() < header.bodyLen()) {
        return std::error_code(EMSGSIZE, std::generic_category());
    }
...
//////////////////////////////////////////////////////////////////////////////
std::error_code CloseComplete::deserialize(const Header &header, const Buffer &buf)
{
    if (buf.size() < header.bodyLen()) {
        return std::error_code(EMSGSIZE, std::generic_category());
    }
...
//////////////////////////////////////////////////////////////////////////////
std::error_code NoticeResponse::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code ParseComplete::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
Password::Password(const std::string &user, const std::string &pass, const Byte4 &salt)
{
    std::string p {pass};
    p += user;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code ParameterStatus::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code BackendKeyData::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code ReadyForQuery::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code DataRow::deserialize(const Header &header, const Buffer &buf, ResultBase &res)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
std::error_code CommandComplete::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
...
//////////////////////////////////////////////////////////////////////////////
//----------------------------------------------------------------------------
std::error_code ErrorResponse::deserialize(const Header &header, const Buffer &buf)
{
    std::error_code ec;
